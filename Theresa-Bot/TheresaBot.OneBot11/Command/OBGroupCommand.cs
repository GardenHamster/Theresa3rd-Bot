...
namespace TheresaBot.OneBot11.Command
{
    public class OBGroupCommand : GroupCommand
    {
        ...
        public OBGroupCommand(BaseSession baseSession, CommandHandler<GroupCommand> invoker, CqGroupMessagePostContext args, string message, string instruction, string command, string prefix)
