            ...
            return Task.Run(async () =>
            {
                try
                {
                    ...
                    for (int i = 0; i < StepDetails.Count; i++)
                    {
                        ...
                        await GroupCommand.ReplyGroupMessageWithQuoteAsync(stepDetail.Question);
                        ...
                        while (true)
                        {
                            ...
                            {
                                if (IsRemindTimeout) await GroupCommand.ReplyGroupMessageWithQuoteAsync("操作超时了，请重新发送指令开始操作");
                                return false;
                            }
