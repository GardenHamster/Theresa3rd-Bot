...
namespace TheresaBot.Main.Session
{
    public abstract class BaseSession
    {
        ...
        public abstract Task<BaseResult> SendGroupMessageAsync(long groupId, params BaseContent[] contents);
        ...
        public abstract Task<BaseResult> SendGroupMergeAsync(long groupId, params List<BaseContent>[] contentLists);

        public abstract Task<BaseResult> SendFriendMessageAsync(long memberId, string message);

        public abstract Task<BaseResult> SendFriendMessageAsync(long memberId, params BaseContent[] contents);
