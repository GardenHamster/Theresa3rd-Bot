                ...
                i.prototype.Q = function (e) {
                    ...
                    i.prototype.bind = function () {
                        ...
                        e.$emoji = {
                            ...
                            e.$preview = {
                                show: function () {
                                    return O ? (e.$emoji.hide(), i.addClass("actived"), n.html((0, E.default)(O)).show(), R()) : e.$preview.hide(),
                                        e.$preview
                                },
                                hide: function () {
                                    ...
                                    n.on("input change blur propertychange", function (r) {
                                        e.cfg.enableQQ && "blur" === r.type && "nick" === t && (n.val() && !isNaN(n.val()) ? (0, b.fetchQQFn)(n.val(), function (e) {
                                            ...
                                            (0, A.default)(".vnick").val(t),
                                                ...
                                                S.mail = r,
                                                S.QQAvatar = e.pic
                                        }) : A.default.store.get(h.QQCacheKey) && A.default.store.get(h.QQCacheKey).nick != n.val() && (A.default.store.remove(h.QQCacheKey), S.nick = n.val(), S.mail = "", S.QQAvatar = "")),
                            ...
                            U = function () {
                                ...
                                n.setACL(N()),
                                    n.save().then(function (t) {
                                        ...
                                        try {
                                            I.rid ? T(t, (0, A.default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), T(t, e.$el.find(".vcards")), k.skip++),
