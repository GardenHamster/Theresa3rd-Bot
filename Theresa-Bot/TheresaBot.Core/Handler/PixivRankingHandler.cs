    ...
    internal class PixivRankingHandler : SetuHandler
    {
        ...
        public async Task PushRankingAsync(PixivRankingTimer rankingTimer, PixivRankingItem rankingItem, PixivRankingMode rankingMode)
        {
            try
            {
                ...
                PixivRankingInfo rankingInfo = await rankingService.FetchRankingInfo(rankingItem, rankingMode, String.Empty);
        ...
        private async Task SendPreviewFileAsync(PixivRankingTimer rankingTimer, PixivRankingInfo pixivRankingInfo, PixivRankingMode rankingMode)
        {
            try
            {
                ...
                string templateMsg = rankingService.GetRankingMessage(pixivRankingInfo.RankingDate, rankingMode.Name, template);
                ...
                setuContents.AddRange(rankingService.GetRankingAndPids(pixivRankingInfo, 10));
        ...
        private async Task ReplyRankingPreview(GroupCommand command, PixivRankingMode rankingMode, PixivRankingItem rankingItem, string search_date)
        {
            try
            {
                ...
                if (pixivRankingInfo == null)
                {
                    ...
                    pixivRankingInfo = await rankingService.FetchRankingInfo(rankingItem, rankingMode, search_date);
